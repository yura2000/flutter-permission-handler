...
public class PermissionHandlerPlugin implements MethodCallHandler {
  ...
  private static final int PERMISSION_GROUP_SPEECH = 2;
  private static final int PERMISSION_GROUP_PHONE = 3;
  private static final int PERMISSION_GROUP_CALENDAR = 4;
  private static final int PERMISSION_GROUP_CAMERA = 5;
  private static final int PERMISSION_GROUP_CONTACTS = 6;
  private static final int PERMISSION_GROUP_LOCATION = 7;
  private static final int PERMISSION_GROUP_LOCATION_ALWAYS = 8;
  private static final int PERMISSION_GROUP_LOCATION_WHEN_IN_USE = 9;
  private static final int PERMISSION_GROUP_PHOTOS = 10;
  private static final int PERMISSION_GROUP_REMINDERS = 11;
  private static final int PERMISSION_GROUP_SENSORS = 12;
  private static final int PERMISSION_GROUP_SMS = 13;
